...
class BxUnaConModule extends BxBaseModConnectModule
{
    ...
    public function serviceGetActions($aWidget)
    {
        ...
        $oInformer->add('sys-module-discontinued', _t('_adm_txt_modules_discontinued', BX_DOL_URL_STUDIO . 'design.php?name=bx_unacon', _t('_bx_unacon_settings')), BX_INFORMER_ALERT);
