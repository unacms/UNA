/*!
  Highlight.js v11.11.2 (git: b4b055f6d4)
...
const[e,a]=r
;if(A.addText(t),t="",c[i]=(c[i]||0)+1,c[i]<=7&&(C+=a),e.startsWith("_"))t+=n[0];else{
...
const a=v.classNameAliases[e[t]]||e[t],i=n[t];a?g(i,a):(S=i,l(),S=""),t++}}
function b(e,n){
...
},b=[l,s,t,e.C_BLOCK_COMMENT_MODE,c,o],m={variants:[{begin:/=/,end:/;/},{
...
keywords:u,relevance:0,contains:[t,e.C_BLOCK_COMMENT_MODE,o,c,s,{begin:/\(/,
end:/\)/,keywords:u,relevance:0,contains:["self",t,e.C_BLOCK_COMMENT_MODE,o,c,s]
}]},s,t,e.C_BLOCK_COMMENT_MODE,l]};return{name:"C",aliases:["h"],keywords:u,
disableAutodetect:!0,illegal:"</",contains:[].concat(m,p,b,[l,{
...
const n=e.regex,t="[\xc0-\u02b8a-zA-Z_$][\xc0-\u02b8a-zA-Z_$0-9]*",a="(?:(?:\\s*\\[\\s*])+)?",i=t+"<@@@>"+a,r="(?:\\?(?:\\s+(?:extends|super)\\s+"+i+")?|"+i+")",s=be("(?:\\s*<\\s*"+r+"(?:\\s*,\\s*"+r+")*\\s*>)?",/<@@@>/g,2),o={
...
contains:[c,e.APOS_STRING_MODE,e.QUOTE_STRING_MODE,ue,e.C_BLOCK_COMMENT_MODE]
},e.C_LINE_COMMENT_MODE,e.C_BLOCK_COMMENT_MODE]},ue,c]}},grmr_javascript:Ne,
...
},c=ue,l=e.COMMENT("/\\*","\\*/",{contains:[e.C_BLOCK_COMMENT_MODE]}),d={
...
const n=te(e),t=ce,a="[\\w-]+",i="("+a+"|@\\{"+a+"\\})",r=[],s=[],o=e=>({
className:"string",begin:"~?"+e+".*?"+e}),c=(e,n,t)=>({className:e,begin:n,
relevance:t}),l={$pattern:/[a-z-]+/,keyword:"and or not only",
attribute:ie.join(" ")},d={begin:"\\(",end:"\\)",contains:s,keywords:l,
relevance:0}
...
const n=te(e),t=se,a=re,i="@[a-z-]+",r={className:"variable",
...
className:"keyword",
match:m(...Ae.filter((e=>"string"!=typeof e)).concat(Me).map(ke),...Oe)}]},c={
$pattern:m(/\b\w+/,/#\w+/),keyword:s.concat(Te),literal:Se},l=[i,r,o],g=[{
...
match:$e}]},...a,...l,...p,f,k,...T,R,I],endsParent:!0,illegal:/["']/},F={
...
end:/\{/,keywords:c,contains:[{scope:"title.class.inherited",match:ze},...l],
...
literal:he,built_in:ve.concat(i),"variable.language":we},c={className:"meta",
